 ...
 * Use the {@link FragmentInner#newInstance} factory method to
...
public class FragmentInner extends Fragment {
     ...
     * @return A new instance of fragment FragmentInner.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentInner newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        logoutButton.setOnClickListener(v -> {
            ...
            Navigation.findNavController(v).navigate(R.id.action_fragmentInner_to_fragmentLogin);
        });
    }
